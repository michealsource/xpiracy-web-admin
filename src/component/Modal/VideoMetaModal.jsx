...
const VideoMetaModal = ({
  ...
  const { getRootProps: getCoverImageRootProps } = useDropzone({
    onDrop,
    multiple: false,
  });
  ...
  const { getRootProps: getSubtitleRootProps } = useDropzone({
  ...
  const submitForEdit = async () => {
    ...
    try {
      ...
      toast.success("Updated Successfully, reflecting soon");
  ...
  return (
    <>
      ...
      >
        <div className="mt-5">
          ...
          <div className="flex items-start w-full py-4 gap-x-4">
            <div className="w-7/12 h-[500px] p-4 welcome-admin-dsh space-y-14">
              <div className=" ">
                <label className="text-[#989898] text-base">
                  Title (required)
                </label>
                <input
                  className="focus:outline-none w-full focus:border-slate-500 focus:ring-slate-500 text-[#8E8C8C] px-4 auth-input h-[50px]"
                  type="text"
                  placeholder=""
                  value={input.video_name}
                  onChange={(e) =>
                    setInput({ ...input, video_name: e.target.value })
                  }
                />
              </div>
              ...
              <div className="pb-4 space-y-2">
                ...
                <select
                  ...
                  onChange={(v) =>
                    setInput({ ...input, placement: v.target.value })
                  }
              ...
              <div className="p-4 welcome-admin-dsh">
                <div className="space-y-4 ">
                  ...
                  <div
                    ...
                    className="border border-dashed border-[#FFFFFF4D] bg-[#FF8F7414] rounded-sm "
                  >
                      ...
                      <div className="flex items-start justify-between ">
                        <div className="flex items-center gap-x-4">
                          ...
                          <div>
                            ...
                            {!editingItem?.video_name && (
                              <p className="">
                                {((mediaFile?.size || 0) / 1024 / 1024).toFixed(
                                  3
                                )}{" "}
                                mb
                              </p>
              ...
              <div className="p-4 welcome-admin-dsh">
                <div className="space-y-4 ">
                  ...
                  <div
                    ...
                    className="border border-dashed border-[#FFFFFF4D] bg-[#FF8F7414] rounded-sm pb-4"
                  >
                    <div className="flex flex-col items-center justify-center px-4 py-5 mx-auto">
                      <div className="w-[50px] h-[50px]">
                        <img src={uploadIcon} alt="" />
          ...
          <div className="border-t-[#FFFFFF38] border-t p-4">
            <div className="flex items-end justify-end">
              <div
                ...
                className="flex items-center cursor-pointer gap-x-2 bg-[#F52F00] py-4 px-6 rounded-full text-sm"
              >
                <BsPlusLg />
                <CustomButton
                  // onClick={() => submitNow()}
                  title={
                    editingItem?.video_name ? "Edit Video" : "Upload video"
                  }
                />
              </div>
            </div>
      ...
      <CongratulationsModal OpenTwo={OpenTwo} onClose={toggle} />
    </>
  );
};
