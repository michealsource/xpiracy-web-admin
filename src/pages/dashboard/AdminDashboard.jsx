    ...
    <div className="w-full py-16 px-7 ">
      <div className="flex items-start justify-between gap-x-8 ">
        <div className="w-8/12 ">
          <div className="welcome-admin-dsh h-[300px]">
            <div className="relative flex items-center justify-between px-5 ">
              ...
              <div className="w-[400px] h-[400px] absolute -bottom-[45%] -right-8">
            ...
            <div className="w-6/12 welcome-admin-dsh">
              <div className="p-4">
                ...
                <div>
                  ...
                  <h4 className="mb-4 text-4xl font-normal ">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <p className="text-[#FFFFFF59] text-sm">
                      {statSelector?.stat?.totalThankYou || "----"}
                    </p>
                  </div>
                  <div className="flex items-center justify-between">
                    <h5 className="text-base ">Total users</h5>
                    <p className="text-[#FFFFFF59] text-sm">
                      {statSelector?.stat?.allUsers || "----"}
                    </p>
                  </div>
                  <div className="border-b border-[#FFFFFF20] text-2xl font-normal mb-4"></div>
                  {/* <h4 className=" text-base font-normal py-4 text-[#F52F00]">
                    Goto Analytics
                  </h4> */}
                </div>
              </div>
        ...
        <div className="w-5/12 ">
          <div className="h-auto welcome-admin-dsh">
            <div className="p-4 ">
              ...
              <div className="border-t border-[#FFFFFF20] text-2xl font-normal mt-4"></div>
              <Link
                to="/comments"
                className="text-base font-normal mt-4 text-[#F52F00] "
              >
                View All
              </Link>
            </div>
            ...
            <div className="p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  ...
                  <option value={60} className="bg-black text-[#fff] text-sm">
                    Last 60days
                  </option>
                  <option value={0} className="bg-black text-[#fff] text-sm">
                    All
                  </option>
                </select>
              </div>
